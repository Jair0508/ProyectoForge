...
public class ControladorLibro {
    ...
    @GetMapping("/anexar")
    public String mostrarLibroAutorGenero(@ModelAttribute("libro") Libro libro, @ModelAttribute("autor") Autor autor, @ModelAttribute("genero") Genero genero, HttpSession session, Model model) {
    ...
    public String anexarGenero(@Valid @ModelAttribute("genero") Genero genero, BindingResult result, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (unique != null) {
            ...
            // redirectAttributes.addFlashAttribute("repetidoGenero", "Nombre genero ya se encuentra en registro");
    ...
    public String anexarAutor(@Valid @ModelAttribute("autor") Autor autor, BindingResult result, Model model, RedirectAttributes redirectAttributes) {
