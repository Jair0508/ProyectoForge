            ...
            <svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
              ...
              <g id="SVGRepo_iconCarrier">
                <g id="Layer_1_1_" display="none">
                  <circle display="inline" fill="#85bea2" stroke="#85bea2" stroke-miterlimit="10" cx="-195.7" cy="86.9" r="115.4">
                  </circle>
                  ...
                  <g display="inline">
                    <g id="XMLID_1_">
                      <g>
                        ...
                        <path fill="#85bea2" d="M-235,58.2l54.9,73.8c-8.4-2-22.2-14.7-34.5-32.5C-226.5,82.5-234.8,66.7-235,58.2z">
                        </path>
                        <path fill="#85bea2" d="M-244.3,167.2l0.4,1.6l-1.6,1.1C-244.2,168.8-244.3,167.5-244.3,167.2z"></path>
                        <path fill="#85bea2"
                        ...
                        <path fill="#85bea2" d="M-244.3,167.1L-244.3,167.1C-244.3,167.2-244.3,167.1-244.3,167.1z"></path>
                        <polygon fill="#85bea2" points="-251.8,134.2 -249.3,145.2 -261.3,147.5 -261.5,147.6 -264.2,137.5 ">
                        </polygon>
                        <path fill="#85bea2" d="M-252,174.4l-1.8,1.2l-0.4-1.3C-253.9,174.8-253.3,175.2-252,174.4z"></path>
                        <path fill="#85bea2"
                          d="M-254.2,174.3l0.4,1.3l-1.6-0.7l0.9-1.7c0,0,0,0,0,0C-254.4,173.5-254.4,173.9-254.2,174.3z"></path>
                        <path fill="#85bea2"
                  ...
                  <polyline display="inline" fill="none" stroke="#85bea2" stroke-width="8" stroke-miterlimit="10"
                    points="-84.9,-24.2 41.8,-150.8 713.2,-150.8 "></polyline> <text transform="matrix(1 0 0 1 45.8244 -158.4465)"
                    display="inline" font-family="'ArialMT'" font-size="76.3085px">Announcements</text>
                  <line display="inline" fill="none" stroke="#85bea2" stroke-width="7" stroke-miterlimit="10" x1="451" y1="226.6"
                    x2="493.2" y2="184.4"></line>
                  <path display="inline" fill="none" stroke="#85bea2" stroke-width="17" stroke-miterlimit="10" d="M436.6,241">
                  </path>
                  <polyline display="inline" fill="none" stroke="#85bea2" stroke-width="8" stroke-miterlimit="10"
                  ...
                  <path display="inline" fill="none" stroke="#85bea2" stroke-width="2" stroke-miterlimit="10" d="M-335.8-482.1">
                  </path>
                  <path display="inline" fill="none" stroke="#85bea2" stroke-width="2" stroke-miterlimit="10" d="M-351.4-469.3">
                  </path>
                  <path display="inline" fill="#85bea2" d="M-324-465.4c0,0,2.4,8.8-1.8,15.1l-3.9,1.9l-4.4-13.2L-324-465.4z">
                  </path>
                  <line display="inline" fill="none" stroke="#85bea2" stroke-width="2" stroke-miterlimit="10" x1="-336.5"
                    y1="-459.9" x2="-325.1" y2="-470"></line>
                </g>
                <g id="Layer_6"> </g>
                <g id="Layer_2"> </g>
                ...
                <g id="Layer_13" display="none">
                  ...
                  <line display="inline" fill="none" stroke="#6AA6CD" stroke-width="8" stroke-miterlimit="10" x1="128" y1="-58.3"
                    x2="128" y2="127.7"></line>
                  <path display="inline" fill="none" stroke="#6AA6CD" stroke-width="8" stroke-miterlimit="10"
                    d="M-58.4,128 c0,0,120,23.4,54.6,131.8c0,0,116.4-61.7,131.8,54.5c0,0,24-121.8,131.8-54.5c0,0-65.3-115.1,54.6-131.8H-58.4z">
                  </path>
                  <path display="inline" fill="none" stroke="#6AA6CD" stroke-width="8" stroke-miterlimit="10"
                  ...
                  <line display="inline" fill="none" stroke="#6AA6CD" stroke-width="8" stroke-miterlimit="10" x1="128" y1="314.3"
                    x2="128" y2="128.3"></line>
                  <g display="inline">
                ...
                <g id="Layer_14" display="none"> <text transform="matrix(1 0 0 1 -4.075 246.8225)" display="inline" fill="#6AA6CD"
                    font-family="'ArialMT'" font-size="374.3166px">A</text> <text transform="matrix(1 0 0 1 -4.075 246.8225)"
                    display="inline" fill="none" stroke="#285674" stroke-width="800px">A</text> </g>
