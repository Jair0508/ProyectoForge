    ...
    <body>
      ...
      <%@ include file="nav.jsp" %>
        ...
        <div class="main-content">
          <h3 id="middle-title">NUESTROS <span>AUTORES</span></h3>
          <div class="cards-container">
            <c:forEach var="autor" items="${paginaAutor.content}" begin="0" end="4">
              <div class="book-card">
                ...
                <div>
                  <h4>Autor:</h4>
                  <h2>
                    <a class="links" href="/autores/${autor.id}/libros?page=0">
        ...
        <div class="pagination">
          <c:if test="${paginaAutor.number > 0}">
            <a href="/generos/${paginaAutor.number}">&#8249; Anterior</a>
          </c:if>

          <c:forEach begin="1" end="${totalPages}" var="index">
            <c:choose>
              <c:when test="${paginaAutor.number + 1 == index}">
          ...
          <c:if test="${paginaAutor.number + 1 < totalPages}">
            <a href="/autores/${paginaAutor.number + 2}">Siguiente &#8250;</a>
          </c:if>
        </div>
